...
public class WaveView extends View {
    ...
    private int mFrontWaveStartColor = 0;
    ...
    private void init(AttributeSet attrs) {
        ...
        int typedArrayInt = typedArray.getInt(R.styleable.WaveView_shape, 0);
    ...
    public void setWaveColor(int behindWaveColor, int frontWaveColor, int frontWaveStartColor) {
        mBehindWaveColor = behindWaveColor;
        mFrontWaveColor = frontWaveColor;
        mFrontWaveStartColor = frontWaveStartColor;
    ...
    private void createShader() {
        ...
        for (int beginX = 0; beginX < endX; beginX++) {
            if (mFrontWaveStartColor != 0) {
                LinearGradient linearGradient = new LinearGradient(
                        beginX, waveY[(beginX + wave2Shift) % endX], beginX, endY,
                        mFrontWaveStartColor, mFrontWaveColor,
                ...
                case CYLINDER:
                    if (borderWidth > 0) {
                        canvas.drawRect(
                                ...
                                borderWidth / 2f,
                                getWidth() - borderWidth / 2f - 0.5f,
                                getHeight() - borderWidth / 2f - 25f - 0.5f,
                                mBorderPaint);
                        canvas.drawArc(
                                borderWidth / 2f,
                                getHeight() - (borderWidth - 50) / 2f,
                                getWidth() - borderWidth / 2f - 0.5f,
                                getHeight() - borderWidth / 2f - 0.5f,
                                0, 180, false,
                                mBorderPaint);
                    ...
                    canvas.drawRect(borderWidth, borderWidth, getWidth() - borderWidth,
                            getHeight() - borderWidth - 25, mViewPaint);
                    canvas.drawArc(borderWidth, getHeight() - borderWidth - 50, getWidth() - borderWidth,
                            getHeight() - borderWidth, 0, 180, false, mViewPaint);
                    break;
            }
        } else {
